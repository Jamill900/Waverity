...
export class InMemoryDataService implements InMemoryDbService {
  createDb() {
    let news = [
      {
        id: 1,
        cover: '../../assets/images/oil1.png',
        title: 'The first product of WAVERITY: Seismic Image Quality Enhancement (S.I.Q.E.)',
        info: 'For the last 11 months, our team in collaboration with BP AGT geophysical specialists worked on the development of a novel technique that enables significant enhancement in vertical resolution while broadening the seismic data bandwidth.\n\n Integration of advanced AI algorithms with signal processing allowed to mitigate one of the main shortcomings of the conventional approaches as deep learning-based SIQE does not require the availability of well data or any prior geological interpretation.\n\n As the result of SIQE seismic data enhancement, specialists are able to better comprehend and mitigate their risks during the major well planning activities throughout the different stages of the field development starting from exploration to depletion.',
        date: '24 February 2022'
      },
      {
        id: 2,
        cover: '../../assets/images/news2.png',
    ...
    let oil = [
      {
        ...
        cover: '../../assets/images/oil1.png',
        cover2: '../../assets/images/oil1after.png',
        cover3: '../../assets/images/oil1before.png'
      },
      {
        id: 2,
        button: 'S.I.N.A',
        ...
        cover: '../../assets/images/oil2.png',
        cover2: '../../assets/images/oil2after.png',
        cover3: '../../assets/images/oil2before.png'
      },
      {
        id: 3,
    ...
    let rss = [
      {
        ...
        cover: '../../assets/images/rss1.png',
        cover2: '../../assets/images/rss1after.png',
        cover3: '../../assets/images/rss1before.png'
      },
      {
        id: 2,
    ...
    let custom = [
      {
        ...
        cover: '../../assets/images/custom1.jpg'
      },
      {
        id: 2,
        ...
        cover: '../../assets/images/custom2.jpg'
      }
    ];

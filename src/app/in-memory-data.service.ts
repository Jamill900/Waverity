  ...
  createDb() {
    let news = [
      ...
      },
      {
        ...
        title: 'A successful application of the S.I.Q.E. algorithm on seismic data of three fields from the SWAP area',
        info: 'We are happy to announce that WAVERITY Team has successfully implemented the Seismic Imaging Quality Enhancement (S.I.Q.E.) algorithm in three fields (North Khali, Bibi Heybat, Qarabatdakh), which are located within Shallow Water Absheron Peninsula (SWAP) area and undergoing exploration activities.\n\nWhile each of these three fields is unique in terms of its geological setting, exploration objectives, and seismic data quality, the S.I.Q.E. has effectively increased the vertical resolution and removed various types of noise in all cases, making the geological interpretation more efficient.\n\nConsidering the very limited amount of well data, the validation was done by means of analyzing various types of attribute maps, as well as applying seismic stratigraphy methods to identify and compare important stratigraphic events between original and processed seismic volumes.\n\n Overall, we achieved up to a 40% increase in dominant frequency (which practically translates to doubling, in some cases tripling, the number of troughs and peaks in reservoir intervals). We also improved the signal-to-noise ratio by 24% resulting in a much cleaner seismic image.',
        date: '4 August 2022'
      }
    ];
